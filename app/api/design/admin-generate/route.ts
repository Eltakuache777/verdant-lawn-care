...
// marked "paid" with amountPaid: 0. Tier defaults to "standard" (cheapest)
// rather than always the priciest, since this is also how the owner tests
// prompt/settings changes and each run spends real AI credits. The rest of
// the pipeline (/design/success -> /api/quote/generate) is unchanged.
